...
from .TMNLoadData import NTMDataLoader, NTMDataSet, loadFeatures , generateTrainAndTest , getSeqsFromKeys
...
def trainNTM(args, model, seqs):
    ...
    model.load_state_dict(torch.load(args.modelFile + r".VAE"))
...
def main():
    ...
    seqs = getSeqsFromKeys(seqs_keys)
